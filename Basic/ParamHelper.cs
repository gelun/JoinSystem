...
namespace Basic
{
    ...
    /// Discuz参数类
    /// </summary>
    public class ParamHelper : IComparable
    {
        private string name;
        ...
        protected ParamHelper(string name, object value)
        {
            this.name = name;
            this.value = value;
        }
        ...
        public static ParamHelper Create(string name, object value)
        {
            return new ParamHelper(name, value);
        }
        ...
        {
            if (!(obj is ParamHelper))
                return -1;

            return this.name.CompareTo((obj as ParamHelper).name);
        }
