...
namespace Basic
{
    ...
    /// 工具类
    /// </summary>
    /// 2012-10-13增加函数IsExistDirectory，ChangeDirectoryName
    public class Utils
    {
        /// <summary>
        /// 版本信息类
        ...
        {
            return TypeConverter.ObjectToDecimal(strValue, defValue);
        }
        ...
        {
            return TypeConverter.StrToDateTime(strValue, defValue);
        }

        public static DateTime StrToDateTime(string strValue)
        {
            return TypeConverter.StrToDateTime(strValue);
        }

        public static string StrToDateStr(string strValue, DateTime defValue)
        {
            return TypeConverter.StrToDateStr(strValue, defValue);
        }
        public static string StrToDateStr(string strValue)
        {
            return TypeConverter.StrToDateStr(strValue);
        }
        ...
        /// <summary>
        /// 判断文件夹是否存在，如果不存在创建,返回true本来就存在，false不存在已经创建了
        /// </summary>
        /// <param name="strFolder">要创建的文件夹</param>
        /// <returns>true本来就存在，false不存在已经创建了</returns>
        public static bool IsExistDirectory(string strDirectory)
        {
            string str = System.Web.HttpContext.Current.Server.MapPath(strDirectory);
        ...
        ///// <summary>
        ///// 将原有文件夹重命名，如果有新文件提示false，否则返回ture
        ///// </summary>
        ///// <param name="OldDirectory"></param>
        ///// <param name="NewDirectory"></param>
        ///// <returns></returns>
        //public static bool ChangeDirectoryName(string OldDirectory,string NewDirectory)
        //{
        //    Microsoft.VisualBasic.Devices.Computer MyComputer = new Microsoft.VisualBasic.Devices.Computer();
        //    string strNewDirectory = System.Web.HttpContext.Current.Server.MapPath(NewDirectory);
        //    if (!Directory.Exists(strNewDirectory))
        //    {
        //        //如果不存在新文件夹
        //        if (Directory.Exists(OldDirectory)) //存在老文件夹,重命名
        //        {
        //            string[] sArray = NewDirectory.Split('/');
        //            NewDirectory = sArray[sArray.Length - 1];
        //            NewDirectory = "22222";
        //            MyComputer.FileSystem.RenameDirectory(System.Web.HttpContext.Current.Server.MapPath(OldDirectory), NewDirectory);
        //            return true;
        //        }
        //        else
        //        {
        ...
        public static string CutStringEndth(string str)
        {
            if (str.EndsWith(","))
            {
