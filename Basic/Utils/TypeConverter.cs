...
namespace Basic
{
    public class TypeConverter
    {
        ...
        {
            return ObjectToDecimal(strValue, 0m);
        }
        ...
        public static decimal StrToDecimal(string strValue)
        {
            ...
            return StrToDecimal(strValue.ToString(), 0m);
        }
        ...
        {
            return StrToDateTime(str, new DateTime(1900, 1, 1, 0, 0, 0));
        }
        ...
        public static string StrToDateStr(string str, DateTime defValue)
        {
            if (!string.IsNullOrEmpty(str))
            {
                DateTime dateTime;
            ...
            return string.Format("{0:yyyy-MM-dd}", defValue);
        }
        public static string StrToDateStr(string str)
        {
            return StrToDateStr(str, new DateTime(1900, 1, 1, 0, 0, 0));
        }
