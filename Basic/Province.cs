...
namespace Basic
{
    ...
    {
        public static void SetProvince(System.Web.UI.WebControls.DropDownList ddl)
        {
            string[] item = "请选择,北京,上海,重庆,安徽,福建,甘肃,广东,广西,贵州,海南,河北,黑龙江,河南,香港,湖北,湖南,江苏,江西,吉林,辽宁,澳门,内蒙古,宁夏,青海,山东,山西,陕西,四川,台湾,天津,新疆,西藏,云南,浙江,海外,未知".Split(',');
            for (int i = 0; i < item.Length; i++)
	            ddl.Items.Insert(i, item[i].ToString());
        }
        ...
        /// </summary>
        /// <returns></returns>
        public void CreateCityItem(System.Web.UI.WebControls.DropDownList ddlProvince, System.Web.UI.WebControls.DropDownList ddlCity)
        {
