<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Left.aspx.cs" Inherits="Join.Agency.Left" %>
...
<body>
    ...
    <div class="subNavBox">
        ...
        <ul class="navContent " style="display: block">
            ...
            <li><a href="#" target="right">栏目管理</a></li>
            <li><a href="#" target="right">内容管理</a></li>
            <li><a href="#" target="right">栏目管理</a></li>
            <li><a href="#" target="right">栏目管理</a></li>
        </ul>
        <div class="subNav">
            信息管理</div>
        <ul class="navContent">
            <li><a href="#" target="right">添加新闻</a></li>
            <li><a href="#" target="right">新闻管理</a></li>
            <li><a href="#" target="right">添加新闻</a></li>
            <li><a href="#" target="right">新闻管理</a></li>
        </ul>
        <div class="subNav">
